...
const DynamicFeatures = ({ section, onEdit }: DynamicFeaturesProps) => {
        ...
        >
          ...
          <div className="w-full overflow-hidden">
            ...
            <div className="flex lg:justify-center">
              ...
              <div 
                className={`flex flex-row gap-3 md:gap-3 lg:gap-2 ${isPreviewMode ? 'animate-scroll' : ''}`}
                style={{ 
                  animationDuration: isPreviewMode ? '40s' : 'none', 
                  animationIterationCount: isPreviewMode ? 'infinite' : 'none',
                  animationTimingFunction: isPreviewMode ? 'linear' : 'none',
  ...
  /* Stop animation on XL+ screens when NOT in preview mode */
  @media (min-width: 1280px) {
    body:not(:has(.fixed)) .animate-scroll {
      animation: none;
    }
  }
