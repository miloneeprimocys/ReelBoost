...
const DynamicFeatures = ({ section, onEdit }: DynamicFeaturesProps) => {
  ...
  const content = {
    ...
    features: section?.content?.features || featuresContent?.features || defaultContent.features,
    cards: section?.content?.cards || featuresContent?.cards || defaultContent.cards
  };
      ...
      <div className="max-w-7xl mx-auto overflow-x-hidden px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="w-full overflow-hidden">
            ...
            <div className="flex lg:justify-center">
              ...
              {/* Inner Track - Animated carousel for all screens except 2xl */}
              <div 
                className="flex flex-row gap-3 md:gap-3 lg:gap-2 animate-scroll"
                style={{ 
              ...
              >
                ...
                {[...(content?.features || []), ...(content?.features || [])].map((item: any, idx: number) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 xl:grid-cols-12 gap-6 mb-6">
          ...
          <div 
            ...
            className="transition-all duration-300 hover:-translate-y-2 md:col-span-1 lg:col-span-3 xl:col-span-3 text-black rounded-[32px] p-8 flex flex-col justify-between overflow-hidden"
          ...
          >
            <div className="flex flex-col h-full">
              <div className="text-center">
                ...
                <p 
                  className="text-[16px] mt-1 mb-6 break-words max-w-full px-2"
                  style={{ color: content?.cardDescriptionColor || '#4B5563' }}
                >
          ...
          <div className="md:col-span-2 lg:col-span-6 xl:col-span-6 flex flex-col gap-6">
            {/* Payment History */}
            {(content?.cards?.[2] || true) && (
            <div 
              className="text-black rounded-[32px] transition-all duration-300 hover:-translate-y-2 p-6 md:p-8 flex flex-col md:flex-row justify-between items-start md:items-center relative overflow-hidden min-h-[200px]" 
              onClick={(e) => e.currentTarget.classList.toggle('-translate-y-2')}
  ...
  /* Stop animation on 2xl+ screens (1536px+) */
